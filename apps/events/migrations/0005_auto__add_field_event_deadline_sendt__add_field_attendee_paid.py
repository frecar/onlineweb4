...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.deadline_sendt'
        db.add_column(u'events_event', 'deadline_sendt',
    ...
    def backwards(self, orm):
        # Deleting field 'Event.deadline_sendt'
        db.delete_column(u'events_event', 'deadline_sendt')
    ...
    models = {
        ...
        u'authentication.onlineuser': {
            ...
            'started_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 1, 0, 0)'}),
        ...
        u'events.event': {
            ...
            'deadline_sendt': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True'}),
